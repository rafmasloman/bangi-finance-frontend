import { ActionIcon, Flex, Group, Stack, Table, Text } from '@mantine/core';
...
import { tableHeadSupplierCompany } from '../helpers/supplier.helper';

const SupplierCommunityPanel = () => {
  ...
  if (supplierCategories.isLoading) {
      ...
      <TableDataLayout>
        ...
        <Stack className="overflow-x-auto scrollbar-hide">
          <Table classNames={{ th: `text-base` }}>
            <TableDataHead data={tableHeadSupplierCompany} />

            {!supplierCategories.data ? (
              <Text>Loading...</Text>
            ) : (
              <TableDataBody
...
export default SupplierCommunityPanel;
